...
const defaultClasses = {
    ...
    // 'text-disabled': {color: Colors.gray2},
    'text-white': {color: '$white'},
    // 'text-black': {color: Colors.black},
    // 'text-white-half': {color: Colors.opacity.white(0.5)},
    'text-center': {textAlign: 'center'},
    // 'text-gray-1': {color: Colors.gray1},
    // 'text-gray-2': {color: Colors.gray2},
    // 'text-gray-3': {color: Colors.gray3},
    // 'text-gray-4': {color: Colors.gray4},
    // 'text-gray-5': {color: Colors.gray5},
    // 'text-orange': {color: Colors.orange},
    // 'text-warn': {color: Colors.warnText},
    // 'text-warn-alt': {color: Colors.warnAlt},
    // 'text-warn-title': {color: Colors.opacity.warn(1)},
    // 'text-warn-desc': {color: Colors.opacity.warn(0.64)},
    // 'text-danger': {color: Colors.red},
     ...
     * Backgrounds
     */
    // 'bg-transparent': {backgroundColor: Colors.opacity.white(0)},
    // 'bg-warn': {backgroundColor: Colors.opacity.warn(0.32)},
    // 'bg-warn-alt': {backgroundColor: Colors.warnAlt},
    ...
    // 'bg-highlight': {backgroundColor: Colors.orange},
    // 'bg-orange-alt': {backgroundColor: Colors.orange},
    // 'bg-orange': {backgroundColor: Colors.orangeBg},
    // 'bg-dark-blue': {backgroundColor: Colors.darkBlue},
    // 'bg-yellow': {backgroundColor: Colors.warn},
    // 'bg-gray-half': {backgroundColor: Colors.gray1half},
    // 'bg-gray-1': {backgroundColor: Colors.gray1},
    // 'bg-gray-2': {backgroundColor: Colors.gray2},
    // 'bg-gray-3': {backgroundColor: Colors.gray3},
    // 'bg-gray-4': {backgroundColor: Colors.gray4},
    // 'bg-gray-5': {backgroundColor: Colors.gray5},
    // 'bg-purple': {backgroundColor: Colors.purple},
    // 'bg-black': {backgroundColor: Colors.black},
    'bg-black-opacity': {backgroundColor: 'rgba(0, 0, 0, 0.65)'},
    'bg-black-opacity-light': {backgroundColor: 'rgba(0, 0, 0, 0.45)'},
    // 'bg-gray-ultra-light': {backgroundColor: Colors.opacity.black(0.04)},
    ...
    'w-8': {width: '8 * $imgRem'},
    'w-9': {width: '9 * $imgRem'},
    'w-10': {width: '10 * $imgRem'},
    'w-15': {width: '15 * $imgRem'},
    'w-20': {width: '20 * $imgRem'},
    'w-100-p': {width: '100%'},
     ...
     * Height
     */
    'h-1': {height: '1rem * $imgRem'},
    'h-2': {height: '2rem * $imgRem'},
    'h-3': {height: '3rem * $imgRem'},
    'h-4': {height: '4rem * $imgRem'},
    'h-5': {height: '5rem * $imgRem'},
    'h-6': {height: '6rem * $imgRem'},
    'h-7': {height: '7rem * $imgRem'},
    'h-8': {height: '8rem * $imgRem'},
    'h-9': {height: '9rem * $imgRem'},
    'h-10': {height: '10rem * $imgRem'},
    'h-12': {height: '12rem * $imgRem'},
    'h-15': {height: '15rem * $imgRem'},
    'h-20': {height: '20rem * $imgRem'},
    ...
    // 'b-red': {borderColor: Colors.red},
    // 'b-transparent': {borderColor: Colors.transparent},
    // 'b-purple': {borderColor: Colors.purple},
    // 'b-gray-1': {borderColor: Colors.gray1},
    // 'b-gray-2': {borderColor: Colors.gray2},
    // 'b-gray-2-half': {borderColor: Colors.gray2half},
    // 'b-gray-3': {borderColor: Colors.gray3},
    // 'b-gray-4': {borderColor: Colors.gray4},
    // 'b-gray-5': {borderColor: Colors.gray5},
    'b-white': {borderColor: '$white'},
    // 'b-warn': {borderColor: Colors.opacity.warn(0.5)},
    // 'b-warn-alt': {borderColor: Colors.warnAlt},
    // 'b-white-half': {borderColor: Colors.opacity.white(0.5)},
    // 'b-white-quarter': {borderColor: Colors.opacity.white(0.25)},
    // 'b-primary': {borderColor: Colors.blue},
    // 'b-orange': {borderColor: Colors.orangeBg},
    ...
    // 'bl-0': {borderLeftWidth: 0, borderColor: Colors.transparent},
    // 'br-0': {borderRightWidth: 0, borderColor: Colors.transparent},
    // 'b-0': {borderWidth: 0, borderColor: Colors.transparent},
    // 'b-1': {borderWidth: 1, borderColor: Colors.gray2},
    // 'b-2': {borderWidth: 2, borderColor: Colors.gray2},
    // 'bt-1': {borderTopWidth: 1, borderColor: Colors.gray2},
    // 'br-1': {borderRightWidth: 1, borderColor: Colors.gray2},
    'bb-0': {borderBottomWidth: 0},
    // 'bb-1': {borderBottomWidth: 1, borderColor: Colors.gray2},
    // 'bl-1': {borderLeftWidth: 1, borderColor: Colors.gray2},
    // 'bx-1': {borderLeftWidth: 1, borderRightWidth: 1, borderColor: Colors.gray2},
    // 'by-1': {borderTopWidth: 1, borderBottomWidth: 1, borderColor: Colors.gray2},
    // 'bt-2': {borderBottomWidth: 2, borderColor: Colors.gray2},
    // 'br-2': {borderBottomWidth: 2, borderColor: Colors.gray2},
    // 'bb-2': {borderBottomWidth: 2, borderColor: Colors.gray2},
    // 'bl-2': {borderBottomWidth: 2, borderColor: Colors.gray2},
    // 'bx-2': {borderBottomWidth: 2, borderColor: Colors.gray2},
    // 'by-2': {borderBottomWidth: 2, borderColor: Colors.gray2},
    // 'bt-3': {borderBottomWidth: 3, borderColor: Colors.gray2},
    // 'br-3': {borderBottomWidth: 3, borderColor: Colors.gray2},
    // 'bb-3': {borderBottomWidth: 3, borderColor: Colors.gray2},
    // 'bl-3': {borderBottomWidth: 3, borderColor: Colors.gray2},
    // 'bx-3': {borderBottomWidth: 3, borderColor: Colors.gray2},
    // 'by-3': {borderBottomWidth: 3, borderColor: Colors.gray2},
    // 'bt-4': {borderBottomWidth: 4, borderColor: Colors.gray2},
    // 'br-4': {borderBottomWidth: 4, borderColor: Colors.gray2},
    // 'bb-4': {borderBottomWidth: 4, borderColor: Colors.gray2},
    // 'bl-4': {borderBottomWidth: 4, borderColor: Colors.gray2},
    // 'bx-4': {borderBottomWidth: 4, borderColor: Colors.gray2},
    // 'by-4': {borderBottomWidth: 4, borderColor: Colors.gray2},
    // 'bt-5': {borderBottomWidth: 5, borderColor: Colors.gray2},
    // 'br-5': {borderBottomWidth: 5, borderColor: Colors.gray2},
    // 'bb-5': {borderBottomWidth: 5, borderColor: Colors.gray2},
    // 'bl-5': {borderBottomWidth: 5, borderColor: Colors.gray2},
    // 'bx-5': {borderBottomWidth: 5, borderColor: Colors.gray2},
    // 'by-5': {borderBottomWidth: 5, borderColor: Colors.gray2},
    // 'bt-6': {borderBottomWidth: 6, borderColor: Colors.gray2},
    // 'br-6': {borderBottomWidth: 6, borderColor: Colors.gray2},
    // 'bb-6': {borderBottomWidth: 6, borderColor: Colors.gray2},
    // 'bl-6': {borderBottomWidth: 6, borderColor: Colors.gray2},
...
const init = ({theme, extraGlobalVars, customClasses}) => {
    const defaultColors = {
        white: '#FFF',
        black: '#000',
        primaryColor: '#2929b0',
        ...
        lightTextColor: '#FFF',
        primaryTextColorOpacity16: 'rgba(0,0,0,0.16)',
        primaryTextColorOpacity32: 'rgba(0,0,0,0.32)',
        primaryTextColorOpacity64: 'rgba(0,0,0,0.64)',
        lightTextColorOpacity16: 'rgba(255,255,255,0.16)',
    };
    const colors = _.merge(defaultColors, theme);
    const defaultGlobalVars = {
        $rem: 16,
        $white: _.get(colors, 'white'),
        $primaryColor: _.get(colors, 'primaryColor'),
        $primaryTextColor: _.get(colors, 'black'),
        $lightTextColor: _.get(colors, 'lightTextColor'),
        $primaryTextColorOpacity16: _.get(colors, 'primaryTextColorOpacity16'),
        $primaryTextColorOpacity32: _.get(colors, 'primaryTextColorOpacity32'),
        $primaryTextColorOpacity64: _.get(colors, 'primaryTextColorOpacity64'),
        $lightTextColorOpacity16: _.get(colors, 'lightTextColorOpacity16'),
    };
    /**
     * extraGlobalVars will override existing vars in defaultGlobalVars if some var name is exactly equal.
     * @type {any}
     */
    const rawGlobalVars = _.merge(defaultGlobalVars, extraGlobalVars);
    EStyleSheet.build(rawGlobalVars);
    classes = EStyleSheet.create(_.merge(defaultClasses, customClasses));
};
